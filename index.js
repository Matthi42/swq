...
(function($PS) {
  ...
  var Types = $PS["Types"];                
  var toBriefAnrede = function (a) {
      var combine = Data_Foldable.intercalate(Data_Foldable.foldableArray)(Data_Monoid.monoidString)(" ")(a.titel) + (" " + a.nachname);
      if (a.sprache instanceof Types.Englisch) {
          if (a.geschlecht instanceof Data_Maybe.Just && a.geschlecht.value0 instanceof Types.M) {
              return "Dear Mr " + combine;
          };
          if (a.geschlecht instanceof Data_Maybe.Just && a.geschlecht.value0 instanceof Types.W) {
              return "Dear Ms " + combine;
          };
          if (a.geschlecht instanceof Data_Maybe.Nothing) {
              return "Dear Sir or Madam " + a.nachname;
          };
          throw new Error("Failed pattern match at Kontaktsplitter (line 114, column 15 - line 117, column 50): " + [ a.geschlecht.constructor.name ]);
      };
      if (a.sprache instanceof Types.Deutsch) {
          if (a.geschlecht instanceof Data_Maybe.Just && a.geschlecht.value0 instanceof Types.M) {
              return "Sehr geehrter Herr " + combine;
          };
          if (a.geschlecht instanceof Data_Maybe.Just && a.geschlecht.value0 instanceof Types.W) {
              return "Sehr geehrte Frau " + combine;
          };
          if (a.geschlecht instanceof Data_Maybe.Nothing) {
              return "Sehr geehrte Damen und Herren " + a.nachname;
          };
          throw new Error("Failed pattern match at Kontaktsplitter (line 118, column 14 - line 121, column 62): " + [ a.geschlecht.constructor.name ]);
      };
      throw new Error("Failed pattern match at Kontaktsplitter (line 113, column 19 - line 121, column 62): " + [ a.sprache.constructor.name ]);
  };
                  ...
                  return Control_Bind.bind(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Control_Alt.alt(Text_Parsing_Parser.altParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(pVornamenNachname))(Text_Parsing_Parser_Combinators["try"](Data_Identity.monadIdentity)(pNachnameKommaVorname)))(function (v1) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Text_Parsing_Parser.bindParserT(Data_Identity.monadIdentity))(Text_Parsing_Parser_String.skipSpaces(Data_Identity.monadIdentity))(function () {
                          return Control_Applicative.pure(Text_Parsing_Parser.applicativeParserT(Data_Identity.monadIdentity))({
                              ...
                              titel: titel,
                              vorname: (function () {
                                  var $14 = Data_Foldable["null"](Data_List_Types.foldableList)(v1.value0);
                                  if ($14) {
                                      return Data_Maybe.Nothing.value;
                                  };
